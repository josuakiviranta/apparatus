...
- [ ] **Step 6: Run all three helper test files together to confirm no cross-module breakage**
...
- [ ] **Step 1: Extend `pipelineEvents.ts` with state types**
...
- [ ] **Step 2: Write the failing test — basic start/text/end flow**
...
- [ ] **Step 4: Write minimal reducer implementation**
...
- [ ] **Step 1: Append this describe block**
...
- [ ] **Step 3: Run the full Chunk-1-and-2 suite for sanity**
