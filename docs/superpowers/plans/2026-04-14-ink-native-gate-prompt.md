...
- [ ] **Step 2: Add `gate-ready` variant to `NodeEvent`**
...
- [ ] **Step 3: Add `gate?` field to `LiveBlock`**
...
- [ ] **Step 2: Add the `gate-ready` case**
...
- [ ] **Step 1: Read the interviewer interface**
...
- [ ] **Step 1: Create `src/attractor/interviewer/ink.ts`**
...
- [ ] **Step 1: Create `src/cli/components/GateSelector.tsx`**
...
- [ ] **Step 2: Append new tests at the end of the file**
...
- [ ] **Step 2: Add `GateSelector` import**
...
- [ ] **Step 3: Special-case the status line for `wait-human`**
...
- [ ] **Step 4: Render `GateSelector` between body lines and status**
...
- [ ] **Step 2: Add `InkInterviewer` import**
...
- [ ] **Step 3: Replace the interviewer line**
...
- [ ] **Step 4: Remove the now-unused `ConsoleInterviewer` import**
