...
- [ ] **Step 1: Write the failing test for `expandVariables`**
...
- [ ] **Step 3: Extract `expandVariables` from `variableExpansionTransform`**
...
- [ ] **Step 3: Add `jsonSchema` to `AgentConfig` and update `buildArgs`**
...
- [ ] **Step 1: Add `output` to `RunResult`**
...
- [ ] **Step 2: Add stdout buffering in `run()` when `jsonSchema` is set**
...
- [ ] **Step 3: Add runtime variable expansion to AgentHandler**
...
- [ ] **Step 3: Implement jsonSchemaFile support in AgentHandler**
...
- [ ] **Step 3: Create chat-summarizer schema**
...
- [ ] **Step 4: Create design-writer schema**
...
- [ ] **Step 1: Write the pipeline DOT file**
...
- [ ] **Step 3: Add `.triage/` to gitignore**
