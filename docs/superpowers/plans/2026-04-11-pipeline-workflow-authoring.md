...
- [ ] **Step 2: Verify the build and export**
...
- [ ] **Step 2: Verify the file is included in tsup build**
...
- [ ] **Step 3: Implement `pipelineListCommand`**
...
- [ ] **Step 4: Verify `graph.goal` is accessible**
...
- [ ] **Step 3: Implement `pipelineCreateCommand`**
...
- [ ] **Step 3: Update `pipelineValidateCommand` signature and shorthand logic**
...
- [ ] **Step 3b: Update the validate call inside `pipelineCreateCommand`**
...
- [ ] **Step 2: Register `create` and `list` subcommands**
...
- [ ] **Step 3: Update the help text block**
