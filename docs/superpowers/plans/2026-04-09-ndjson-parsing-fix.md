...
- [ ] **Step 1: Write test — NDJSON with `{type:"result"}` parses correctly**
...
- [ ] **Step 2: Write test — NDJSON without `{type:"result"}` fails descriptively**
...
- [ ] **Step 3: Write test — NDJSON with object-typed `result` (not string) parses correctly**
...
- [ ] **Step 4: Write test — `raw-output.txt` is written for post-mortem debugging**
...
- [ ] **Step 5: Write test — empty output returns descriptive failure**
...
- [ ] **Step 1: Update markdown-fail test to use NDJSON-aware assertion**
...
- [ ] **Step 2: Run test to verify it still fails (pre-implementation)**
...
- [ ] **Step 1: Add missing-output guard before the existing parse block**
...
- [ ] **Step 2: Replace the array-based parser with NDJSON line-by-line parser**
