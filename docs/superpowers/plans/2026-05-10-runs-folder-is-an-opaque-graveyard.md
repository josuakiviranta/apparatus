...
- [x] **Step 1: Update workflow step 7 (`:17`)**
...
- [x] **Step 2: Update the Resume paragraph (`:489`)**
...
- [x] **Step 3: Update the Trace section (`:493-501`)**
...
- [x] **Step 1: Whole-suite test sweep**
...
- [x] **Step 3: Grep invariants from design §10.1**
...
- [x] **Step 4: No commit** (this task is verification-only). If any check fails, fix in the chunk it belongs to and re-run.
