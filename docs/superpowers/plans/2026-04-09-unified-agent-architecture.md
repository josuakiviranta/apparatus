...
- [ ] **Step 1: Write failing tests for arg building**
...
- [ ] **Step 3: Implement Agent class with buildArgs and expandPrompt**
...
- [ ] **Step 1: Write failing tests for MCP config handling**
...
- [ ] **Step 3: Implement MCP config methods**
...
- [ ] **Step 1: Add asset helper for bundled agents directory**
...
- [ ] **Step 2: Write failing tests for agent registry**
...
- [ ] **Step 1: Study existing prompt files to extract content**
...
- [ ] **Step 5: Create meditate-create.md**
...
- [ ] **Step 6: Create agent-creator.md**
...
- [ ] **Step 7: Update tsup.config.ts to copy agent definitions to dist**
...
- [ ] **Step 8: Build and verify agents are in dist**
...
- [ ] **Step 1: Write failing tests for agent list and show**
...
- [ ] **Step 3: Implement agent list and show**
...
- [ ] **Step 5: Register commands in program.ts**
...
- [ ] **Step 1: Implement agent create action**
...
- [ ] **Step 2: Register create command in program.ts**
