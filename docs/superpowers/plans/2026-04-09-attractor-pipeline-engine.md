...
- [ ] **Step 1: Write `src/attractor/types.ts`**
...
- [ ] **Step 1: Add `LoopResult` to loop.ts and update `LoopOptions`**
...
- [ ] **Step 2: Replace `process.exit` pre-flights with thrown errors**
...
- [ ] **Step 3: Replace SIGINT/SIGTERM handlers with AbortSignal and return LoopResult**
...
- [ ] **Step 4: Check streamEvents signature — add onSessionId option if needed**
...
- [ ] **Step 5: Update implement.ts to wrap runLoop in try/catch + own AbortController**
...
- [ ] **Step 6: Update loop tests for new return type**
...
- [ ] **Step 1: Write failing tests for basic DOT parsing**
...
- [ ] **Step 3: Implement `src/attractor/core/graph.ts`**
...
- [ ] **Step 3: Implement `validateGraph` and `validateOrRaise` in `src/attractor/core/graph.ts`**
...
- [ ] **Step 3: Implement `src/attractor/core/conditions.ts`**
...
- [ ] **Step 2: Implement `src/attractor/checkpoint.ts`**
...
- [ ] **Step 1: Write interviewer tests**
...
- [ ] **Step 2: Implement interviewer files**
...
- [ ] **Step 1: Write failing codergen + ralph handler tests**
...
- [ ] **Step 2: Implement start-exit handler**
...
- [ ] **Step 3: Implement codergen handler**
...
- [ ] **Step 4: Implement ralph-native handlers**
...
- [ ] **Step 5: Wire all handlers into registry**
...
- [ ] **Step 1: Write failing tests for parallel and manager-loop handlers**
...
- [ ] **Step 2: Implement `src/attractor/handlers/parallel.ts`**
...
- [ ] **Step 3: Implement `src/attractor/handlers/manager-loop.ts`**
...
- [ ] **Step 4: Register parallel, fan-in, and manager-loop in registry**
...
- [ ] **Step 2: Implement `src/attractor/core/engine.ts`**
...
- [ ] **Step 1: Write pipeline command tests**
...
- [ ] **Step 2: Implement `src/cli/commands/pipeline.ts`**
...
- [ ] **Step 3: Register pipeline command in program.ts**
...
- [ ] **Step 3: Create a real test pipeline and validate it**
...
- [ ] **Step 4: Verify implement command still works (no regression)**
...
- [ ] **Step 5: Commit DoD verification**
