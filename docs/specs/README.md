...
`ralph` is an npm CLI (`ralph-cli`) that orchestrates Claude Code sessions: running implementation loops, planning sessions, project scaffolding, meditation scripts, and background scheduling.
