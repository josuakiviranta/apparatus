...
- [x] **Step 1: Write failing tests for processLine**
...
- [x] **Step 3: Add the export to assets.ts**
...
- [x] **Step 1: Update implement.ts to set env vars before spawning loop.sh**
...
- [x] **Step 2: Run the smoke test to confirm implement command still compiles**
...
- [x] **Step 1: Replace the jq pipe section in loop.sh**
...
- [x] **Step 2: Verify loop.sh is still valid bash**
...
- [x] **Step 1: Add the new entry to tsup.config.ts**
...
- [x] **Step 3: Verify formatter file was created**
...
- [x] **Step 1: Add stream-formatter.ts to the Codebase Patterns section**
...
- [x] **Step 1: Update the implement command description to document enhanced output**
